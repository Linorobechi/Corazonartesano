            ...
            <div className="p-8 flex flex-col justify-center space-y-4">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  <img src={logoImg} alt="Corazón Artesano" className="w-10 h-10 object-contain rounded-xl drop-shadow-sm" />
                  <div>
                    <h2 className="text-2xl font-bold text-[#8b5e3c] leading-tight">Iniciar Sesión</h2>
                    <span className="text-[10px] text-gray-400 font-semibold tracking-wide">Corazón Artesano</span>
                  </div>
                </div>
