    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="relative z-10 max-w-2xl px-6 flex flex-col items-center"
        >
          <div className="mb-4">
            <img
              src={logoImg}
              alt="Corazón Artesano Logo"
              className="w-20 h-20 md:w-24 md:h-24 object-contain rounded-2xl drop-shadow-xl p-1 bg-white/40 backdrop-blur-sm border border-white/60 hover:scale-105 transition duration-300"
            />
          </div>

          <div className="inline-flex items-center gap-2 bg-white/80 px-4 py-1 rounded-full text-sm text-[#7a4b2c] mb-4 shadow-xs">
            <FaMapMarkerAlt />
            Sincelejo, Sucre
          </div>

          <h1 className="text-4xl md:text-6xl font-bold text-[#3b2a1f] mb-4">
            Corazón Artesano
          </h1>
