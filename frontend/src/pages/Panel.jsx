          ...
          <div className="bg-white rounded-3xl shadow-sm p-8 border border-[#eae0d5] flex justify-between items-center flex-wrap gap-4">
            <div className="flex items-center gap-4">
              <img
                ...
                className="w-16 h-16 object-contain rounded-2xl drop-shadow-sm bg-[#faf7f2] p-1 border border-[#eee3d7]"
              />
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-[#8b5e3c] mt-1.5">
