        ...
        >
          <div className="mb-4">
            <img
              ...
              className="w-20 h-20 md:w-24 md:h-24 object-contain rounded-2xl drop-shadow-xl p-1 bg-white/60 backdrop-blur-sm border border-white/80 hover:scale-105 transition duration-300"
            />
          </div>
